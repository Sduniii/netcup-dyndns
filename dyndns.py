...
@click.option("--repeat", "-r", help="debugging output.", default=3600)
...
def dyndns(conf, hosts, update: bool=False, repeat: int=3600,ttl: int=None, verbose: bool=False):
    """
